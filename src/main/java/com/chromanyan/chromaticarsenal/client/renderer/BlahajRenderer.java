...
@OnlyIn(Dist.CLIENT)
public class BlahajRenderer implements ICurioRenderer {
    // THANK YOU CREATE
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(ChromaticArsenal.MODID, "blahaj"), "blahaj");

    private final HumanoidModel<LivingEntity> model;

    public BlahajRenderer(ModelPart part) {
