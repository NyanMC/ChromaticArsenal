...
public class CAAdvancements extends AdvancementProvider {
    ...
    private static final Item[] CURIOS = new Item[] {
            ...
            ModItems.ASCENDED_STAR.get(), ModItems.WORLD_ANCHOR.get(), ModItems.GRAVITY_STONE.get(), ModItems.VERTICAL_STASIS.get(), ModItems.HARPY_FEATHER.get(), ModItems.SUPER_HARPY_FEATHER.get()
    };
