...
public class CAAdvancementGenerator implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    private static final Item[] CURIOS = new Item[] {
            ModItems.GOLDEN_HEART.get(), ModItems.GLASS_SHIELD.get(), ModItems.WARD_CRYSTAL.get(), ModItems.SHADOW_TREADS.get(), ModItems.DUALITY_RINGS.get(), ModItems.FRIENDLY_FIRE_FLOWER.get(), ModItems.LUNAR_CRYSTAL.get(), ModItems.CRYO_RING.get(), ModItems.BUBBLE_AMULET.get(), ModItems.MOMENTUM_STONE.get(), ModItems.ADVANCING_HEART.get(), ModItems.THUNDERGUARD.get(),
            ...
            ModItems.AMETHYST_RING.get(), ModItems.COPPER_RING.get(), ModItems.VITAL_STONE.get()
    };
    ...
    public void generate(HolderLookup.@NotNull Provider provider, @NotNull Consumer<Advancement> consumer, @NotNull ExistingFileHelper fileHelper) {
        ...
        Advancement advancingHeart = displayedHasItem(ModItems.ADVANCING_HEART.get(), consumer, fileHelper, FrameType.TASK, goldenHeart);
        Advancement thunderguard = displayedHasItem(ModItems.THUNDERGUARD.get(), consumer, fileHelper, FrameType.TASK, new ResourceLocation("adventure/throw_trident"));
        ...
        Advancement amethystRing = simpleHasItemRecipe(ModItems.AMETHYST_RING.get(), consumer, fileHelper);
        Advancement copperRing = simpleHasItemRecipe(ModItems.COPPER_RING.get(), consumer, fileHelper);
        ...
        Advancement blockOneHundred = Advancement.Builder.advancement()
                .addCriterion("blocked_100", new GlassShieldBlockTrigger.TriggerInstance(ContextAwarePredicate.ANY, 100))
                .display(
