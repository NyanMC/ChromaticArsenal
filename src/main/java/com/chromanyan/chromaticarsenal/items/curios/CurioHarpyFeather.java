...
public class CurioHarpyFeather extends BaseCurioItem {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> list, @NotNull TooltipFlag flag) {
        list.add(new TranslatableComponent("tooltip.chromaticarsenal.harpy_feather.1"));
        list.add(new TranslatableComponent("tooltip.chromaticarsenal.harpy_feather.2"));
        list.add(new TranslatableComponent("tooltip.chromaticarsenal.harpy_feather.3"));
    }
